...
Dependencies = {
	...
	BackwardCPP = {
		IncludeDir = "%{wks.location}/Hazel/vendor/backward-cpp"
	},
	Hazel_Net = {
		IncludeDir = "%{wks.location}/Net/Hazel-Net/Source"
	},
	Hazel_Net_GNS = {
		IncludeDir = "%{wks.location}/Net/Hazel-Net/vendor/GameNetworkingSockets/include"
	}
}
